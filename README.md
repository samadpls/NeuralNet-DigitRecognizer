...
3. Run the `digit_recognizer.py` file. or  run on [collab](https://colab.research.google.com/github/samadpls/NeuralNet-DigitRecognizer/blob/main/digit_recognizer.ipynb)
